...
public class Login_Form extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_Create_Account.setText("    CREA UN ACCOUNT");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jButton_Login, javax.swing.GroupLayout.PREFERRED_SIZE, 398, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel3Layout.createSequentialGroup()
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(jLabel_Create_Account, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(154, 154, 154))
        );
    ...
    private void jButton_LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_LoginActionPerformed
        ...
        ResultSet rs;
        String cf = jTextField_Username.getText();
        String password = String.valueOf(jPasswordField.getPassword());
        
            if(cf.trim().equals("username"))
            {
                JOptionPane.showMessageDialog(null, "Inserisci il Codice Fiscale:", "Campo Codice Fiscale vuoto", 2);
            }
            else if(password.trim().equals("password"))
            {
                JOptionPane.showMessageDialog(null, "Inserisci la Password:", "Campo Password vuoto", 2);
            }
            else{  
                   Utente u=OspiteSocial.getInstance().visualizzaInformazioniUtente(cf,password);
                        if(u!=null)
                        {
                            ...
                            JOptionPane.showMessageDialog(null, "Invalido Codife Fiscale  / Password","Errore Login",2);
                        }
            }
