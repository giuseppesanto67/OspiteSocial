...
public class ModificaStanza_Frame extends javax.swing.JFrame {
    ...
    public ModificaStanza_Frame(Integer codiceStanza) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      OspiteSocial.getInstance().modificaDatiStanza(codiceStanza,tipologiaStanza,tipologiaPostoLetto,numPostiLetto);
